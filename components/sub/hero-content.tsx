...
>
  ...
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500">
    DevOps Pipelines
        ...
        >
          I&apos;m A Java Full Stack Software Engineer passionate about building modern web applications and implementing efficient DevOps workflows. Check out my projects and skills to see how I turn ideas into scalable solutions.
        </motion.p>
